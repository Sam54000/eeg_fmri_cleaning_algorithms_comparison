...
class DirectoryTree:
    ...
    def generate_tree(self: 'DirectoryTree'
    ...
    def list_directory_contents(self: 'DirectoryTree'
    ...
    def change_directory(self, target_dir: str | os.PathLike
                         ) -> str | os.PathLike:
    ...
    def print_tree(self: 'DirectoryTree',
                   start_path: str | os.PathLike = None, 
            ...
            with os.scandir(start_path) as entries:
                ...
                for index, entry in enumerate(entries):
                    ...
                    if entry.is_dir():
                        ...
                        self.print_tree(os.path.join(start_path, entry.name), prefix + extension)
                    else:
                        print(f"{prefix}{connector} {entry.name}")
